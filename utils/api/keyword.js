...
export const KEYWORD_API = {
    ...
    LIST_IMAGES_BY_KEYWORD: (keywordId, page, size) => `${API_CONFIG.FILE_BASE_URL}/keyword?keywordId=${keywordId}&page=${page}&size=${size}`, // fetch paginated list of images based on keyword provided
