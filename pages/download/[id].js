...
const Downloader = () => {
    ...
    const { id: fileId, title, path, size, width, height, lightMode,
        style, dominantColors, source, keywords } = imageData || {};
    ...
    return (
        <>
            ...
            <MainLayout
                className='downloaderPage w-full'
                mainTagClassName='w-full h-auto flex-auto'
